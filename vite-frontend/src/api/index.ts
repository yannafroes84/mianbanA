...
export const updateForwardGroup = (id: number, groupName: string) => Network.post("/forward/update-group", { id, groupName });
export const getForwardGroups = () => Network.post("/forward/groups");
